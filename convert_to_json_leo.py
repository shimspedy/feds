...
# Load the Excel file
file_path = './public/2024-law-enforcement-officer-pay-ratesxls.xlsx'
try:
...
for index, row in df.iterrows():
    locname = row['LOCNAME'].replace(' (LEO)', '')  # Remove '(LEO)' from locname
    grade = f"LEO{row['GRADE']}"
...
json_file_path = './public/leo-data.json'
